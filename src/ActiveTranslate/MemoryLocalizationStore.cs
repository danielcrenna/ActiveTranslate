...
{
	public sealed class MemoryLocalizationStore : ILocalizationStore
	{
		private readonly Dictionary<string, List<Localization>> _store;

		public MemoryLocalizationStore() => _store = new Dictionary<string, List<Localization>>();
		...
		public Localization GetValue(string key, string language)
		{
			...
			var missing = new Localization {Value = key, Tag = language, IsMissing = true};
			list.Add(missing);
			return missing;
		}
